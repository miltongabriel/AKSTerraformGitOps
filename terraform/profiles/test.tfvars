...
gh_environment           = "test-apply"
gh_plan_environment      = "test-plan"
registry_app_name        = "gh-actions-gbenettiregistry"
terraform_apply_app_name = "gh-actions-terraform-apply-test"
terraform_plan_app_name  = "gh-actions-terraform-plan-test"
operator_aad_object_ids  = ["74a8e0a7-e567-40b2-bae2-9bad642770fd"]

# terraform/01-aks
aks_default_node_pool_vm_size = "Standard_B2pls_v2" # same cheap free-tier size as dev - bump this before running any real test workload
...
argocd_target_revision  = "test" # this environment's branch - promoted from dev (main) via promote.yml
